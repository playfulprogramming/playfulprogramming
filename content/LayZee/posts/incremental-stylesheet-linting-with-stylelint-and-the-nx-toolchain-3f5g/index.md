...
1. Create Stylelint configuration.
...
1. Add Stylelint editor extension.
...
1. Customize Stylelint configuration.
    We should customize lint rules to our liking. For example, let's adjust our configuration to these preferences in `.stylelintrc`:
      ...
      1. Limit allowed selector characters to lower case letters, digits in addition to the hyphen (`-`) and underscore (`_`) characters.
      1. Use single quotes (`'`).
