...
_**This post is an extract from my new newsletter [The Pragmatic Dev focused](https://newsletter.pragmaticdevx.dev/) on covering developer tools, tips, tricks, and related resources. Please subscribe.**_
