...
{
  title: "Sobre Nós",
  description: "Sobre Unicorn Utterances - quem somos nós, quais são os nossos objetivos e como queremos ajudar no processo de aprendizagem dos outros",
}
---
...
<ul aria-label="As nossas redes sociais" style="display: flex; align-items: center; list-style: none; padding: 0; margin: 0; flex-wrap: wrap; justify-content: center;" role="list">
    <li>
        <a aria-label="O nosso canal do YouTube" style="display: inline-block; margin-right: 1rem" href="https://www.youtube.com/channel/UCpHleOoeCdHNe_2k5nCbWOA/" target="_blank" rel="noopener noreferrer sponsored">
    ...
    <li>
        <a aria-label="O nosso servidor do Discord" style="display: inline-block; margin-right: 1rem"  href="https://discord.gg/FMcvc6T"  target="_blank" rel="noopener noreferrer sponsored">
    ...
    <li>
        <a aria-label="O nosso LinkedIn" style="display: inline-block; margin-right: 1rem" href="https://www.linkedin.com/company/unicorn-utterances"  target="_blank" rel="noopener noreferrer sponsored">
    ...
    <li>
        <a aria-label="O nosso Twitter" style="display: inline-block; margin-right: 1rem" href="https://twitter.com/unicornuttrncs"  target="_blank" rel="noopener noreferrer sponsored">
    ...
    <li>
        <a aria-label="O nosso Facebook" style="display: inline-block; margin-right: 1rem" href="https://www.facebook.com/Unicorn-Utterances-104838014459905"  target="_blank" rel="noopener noreferrer sponsored">
    ...
    <li>
        <a aria-label="O nosso Feed de RSS" style="display: inline-block; margin-right: 1rem" href="https://unicorn-utterances.com/rss.xml"  target="_blank" rel="noopener noreferrer sponsored">
...
<ul aria-label="Os nossos Patrocinadores" role="list" style="list-style: none; padding: 0; margin: 0; display: flex; width: 100%; flex-wrap: wrap; justify-content: center;">
<li style="
    margin: 16px;
">
