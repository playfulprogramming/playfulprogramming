...
_N.B. since [4.7.0](https://github.com/prisma/prisma/releases/tag/4.7.0), this feature has been production ready, so you can remove the `"interactiveTransactions"` flag._
