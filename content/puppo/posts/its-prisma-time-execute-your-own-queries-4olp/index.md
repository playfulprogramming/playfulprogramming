...
*You can read more about this [here](https://www.prisma.io/docs/concepts/components/prisma-client/raw-database-access#sql-injection)*
...
*N.B. If you don't indicate your result type, by default Prisma returns the [unknown](https://dev.to/playfulprogramming/typescript-tips-tricks-any-vs-unknown-2ho6) type*
...
*You can find the code of this article [here](https://github.com/Puppo/it-s-prisma-time/tree/14-execute-your-queries)*
