...
originalLink: "https://dev.to/playfulprogramming/rxjs-marble-testing-2gg9",
...
To test our code in RxJS we use Marble testing. A method that combines the [Marble Diagram](https://dev.to/playfulprogramming/rxjs-marble-diagrams-4jmg) with the code, and allows us to represent the behaviours of our observables and translate them to something that the Testing Framework can understand.
