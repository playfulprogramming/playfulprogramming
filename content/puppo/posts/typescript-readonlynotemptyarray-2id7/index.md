...
The last point that I want to let you is how to convert an Array to a NotEmptyArray. To do that we need to create a [type guard](https://dev.to/playfulprogramming/typescript-tips-tricks-type-guard-50e5) function. This function can be done in this way.
