	...
	return (
		<div>
			<h3 className="text-xl font-semibold text-amber-400">
				Legacy Mode (Blocking Render)
			</h3>
			<p className="text-gray-400 mt-1">
				Type quickly in the input below. You'll notice the input lags and feels
				"janky" because the expensive list rendering is blocking the main
				thread.
			</p>
			<input
				type="text"
	...
	return (
		<div>
			<h3 className="text-xl font-semibold text-cyan-400">
				Concurrent Mode (Non-Blocking Render)
			</h3>
			<p className="text-gray-400 mt-1">
				Type quickly now. The input remains smooth and responsive. React
				prioritizes your typing over the list rendering.
			</p>
			<input
				type="text"
				value={inputText}
			...
			{isPending ? (
				<div className="text-center p-4 mt-4 text-cyan-400">
					Updating list...
				</div>
			) : (
				<SlowList text={filterTerm} />
			...
			<div className="max-w-4xl mx-auto">
				<header className="text-center mb-8">
					...
					<p className="text-gray-400 mt-2">
						Comparing Legacy (Blocking) vs. Concurrent (Non-Blocking) UI Updates
					</p>
				</header>
				...
				<footer className="text-center mt-8 text-gray-500">
					<p>
						Built to demonstrate the benefits of async rendering in React 18+.
					</p>
				</footer>
			</div>
		</div>
