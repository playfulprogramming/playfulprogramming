...
class FileDateComponent {
	...
	constructor() {
		// Input values are not available in the `constructor` usage
		// So we'll need to check the values after the initial render
		// There are much better ways to handle this that we'll touch on soon
		afterRender(() => {
