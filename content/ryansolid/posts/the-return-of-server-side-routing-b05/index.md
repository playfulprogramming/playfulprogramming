...
The common thread is to send less JavaScript to the browser seen most recently championed by [0kb of JS frameworks](https://dev.to/playfulprogramming/is-0kb-of-javascript-in-your-future-48og). But I want to expand on this as the repercussions are about more than progressive enhancement or lazy hydration. Everything is converging on architectural change that we have not seen the likes of since when SPAs came on the scenes over a decade ago.
