...
originalLink: "https://dev.to/playfulprogramming/making-the-case-for-signals-in-javascript-4c7i",
coverImg: "cover-image.png",
socialImg: "social-image.png"
}
---

Amidst all the conversation around Signals the recent weeks, I have forgotten to talk about arguably the most important topic. Why should you care? I've covered their [evolution](https://dev.to/playfulprogramming/the-evolution-of-signals-in-javascript-8ob) and [opposition](https://dev.to/playfulprogramming/react-vs-signals-10-years-later-3k71), but I haven't actually made the case for using them.
...
Finally, historically there were concerns about large uncontrollable graphs. Cycles and unpredictable propagation. These concerns largely are in past due to the work that has been done over the [past several years](https://dev.to/playfulprogramming/the-evolution-of-signals-in-javascript-8ob). I'd go as far as these problems are what Signals solve and why you would use them over other message/event systems.
...
[The Evolution of Signals in JavaScript](https://dev.to/playfulprogramming/the-evolution-of-signals-in-javascript-8ob)
...
[Components are Pure Overhead](https://dev.to/playfulprogramming/components-are-pure-overhead-hpm)
