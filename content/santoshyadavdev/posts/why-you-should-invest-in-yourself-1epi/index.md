---
{
title: "Why You Should Invest In Yourself?",
published: "2019-08-20T19:18:21Z",
...
> I will be speaking at [Ng Srilanka](https://ng-srilanka.com/) this year, if you are planning to come to the conference please give a shout and don't be hesitated to say Hi!
...
* Once I left that job, I used to think I know everything but realized I was too busy working on .NET that I missed learning about new stacks, invest your time to learn about, which stack is being used in technology. Don't ever think you know everything, because
![You know nothing](https://thepracticaldev.s3.amazonaws.com/i/wg5mna0u17v93l6kr3iv.jpeg)
...
* [Azure](https://azure.microsoft.com/en-in/) provides free 12 months with many free services and credits
* [GCP](https://cloud.google.com/) provides 12 months free access to all service.
* [AWS](https://aws.amazon.com) provides free tier plan.
...
## Heard About Netlify Deploy Builder


Netlify is awesome, so easy to use, so we decided to build a Custom Builder to deploy Angular App using CLI.
Do give it a try :
[Netlify Builder](https://github.com/ngx-builders/netlify-builder)

Also if you are looking for Custom Builders, you can access them on below app created for Angular Community:
[Angular Builder](https://angular-builders.dev)
