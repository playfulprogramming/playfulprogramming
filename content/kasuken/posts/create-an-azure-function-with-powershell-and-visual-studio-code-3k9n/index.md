...
![Create a new Azure Function](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/254ag45dhng620mzzogy.png)
...
![project structure](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/kcbyz4kndwtv28k0gcl0.png)
...
You should see a message saying "Hello, {name}" where {name} is a query parameter that you can pass to your function. For example, if you use [http://localhost:7071/api/MyFunction?name=MadMax](http://localhost:7071/api/MyFunction?name=MadMax), you should see "Hello, MadMax".
...
![Debugging](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/6ey31teq8wdch2hvshzu.png)
...
![Variables](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/awl71o7rwbdm6cqa8kqc.png)
...
![Deploy the Azure Function](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/xupsfy5diy3tmwy4ze5k.png)
