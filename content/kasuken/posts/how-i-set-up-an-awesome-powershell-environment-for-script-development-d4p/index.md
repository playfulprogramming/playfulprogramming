...
![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/kp6qz7iibopxfl86z8e9.png)
...
{% embed https://dev.to/this-is-learning/transforming-windows-terminal-into-a-productivity-powerhouse-53d5 %}

## Final result
If everything run well, every time you open a new PowerShell instance, you should see something like that:

![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/iggn0sdgmllfrseej2vw.png)
