...
If you don't have an idea about docker, please read the preview post about [docker from zero to survives](https://dev.to/playfulprogramming/docker-from-zero-to-survive-40ho)
