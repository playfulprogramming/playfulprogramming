...
I just read this book from Francesco Strazzullo titled "[Decision Making for Software Development Teams](https://leanpub.com/decision-making-for-software-development-teams/c/dev-leonardo)" and today I'll briefly summarize about the 4 anti-patterns described in the first chapter of the book: hype-driven development (basically the latest shiny technology), the usual path (which I like to call "we've always done it that way"), the expert (or "trust me bro") and rage-driven decisions.
