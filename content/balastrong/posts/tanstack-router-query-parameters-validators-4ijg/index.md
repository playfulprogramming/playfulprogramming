...
In the [first article](https://dev.to/playfulprogramming/tanstack-router-setup-routing-in-react-4gf7) we saw how to set up a new project with TanStack Router and how to create a couple of routes.

In the [second article](https://dev.to/playfulprogramming/tanstack-router-setup-routing-in-react-4gf7) instead, the focus was on path parameters and loaders.
