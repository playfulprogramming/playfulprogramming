...
![Angular component with inline template (without language service)](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/qse9xekg2p46iff779rq.png)
...
![Angular component with syntax highlighting](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/n3xg95rzus292cp3s1g7.png)
...
![Event binding information](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/i5tgva7mhv534o65dw2b.png)
...
![$event information](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/dto5fm6gphrms6ayi7gn.png)

Let’s add a component that has an **Output**, and add it in the template.

![CardGameComponent](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/dw7dbinacq5m21kq49ow.png)
...
![Information about event binding in a component output](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/907aa2pea2tccc5ud36g.png)
...
![Interpolation information](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/7nwu8lnoaq5vvn7km0pn.png)
...
![Data binding information](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/h6rs9m35ig4q6c5tvfz1.png)

Let’s change the property on LazyComponent to be of string type and see what we get:

![Error regarding property being passed to the component (type error)](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/3gokab3zrbvvhky7f8eq.png)
...
![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/rps2q0g8p4z3m8icyzkn.png)
...
![Image description](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/bvom4d6b2z3pytz6olr8.png)
...
_Till then, go install the language service (if you haven’t yet) and use it to the fullest, it has a lot to give and make your coding easier!_