...
*I’ve explained it more deeply in my previous post: [It’s ok to use function calls in Angular templates!](https://dev.to/playfulprogramming-angular/its-ok-to-use-function-calls-in-angular-templates-4029) , where I explain how pipes memoization works and how we can do the same thing too when using normal functions.*
